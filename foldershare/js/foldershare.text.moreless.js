...
(function($, Drupal, drupalSettings) {
  ...
  Drupal.foldershareTextMoreLess = Drupal.foldershareTextMoreLess || {
    ...
    attach: function (pageContext, settings) {
      ...
      $('.foldershare-text-moreless').once('foldershare-text-moreless').each(function() {
        var $outer = $(this);
  ...
  Drupal.behaviors.foldershare_TextMoreLess = {
    attach: function (pageContext, settings) {
      Drupal.foldershareTextMoreLess.attach(pageContext, settings);
    }
  };
