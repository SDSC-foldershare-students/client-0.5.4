 ...
 *  pageTitle       = @Translation("Upload to @operand"),
 *  menuNameDefault = @Translation("Upload..."),
 *  menuName        = @Translation("Upload to @operand..."),
  ...
  public function execute() {
    ...
    if ($nUploaded === 1) {
      ...
      $this->addExecuteMessage(t(
        ...
        [
          '@kind' => Utilities::mapKindToTerm(FolderShare::FILE_KIND),
          '@name' => $name,
        ]),
        'status');
    }
    elseif ($nUploaded > 1) {
      ...
      $this->addExecuteMessage(t(
        Messages::UPLOAD_DONE_MULTIPLE_ITEMS,
        [
          '@number' => $nUploaded,
          '@kinds'  => Utilities::mapKindToTerms(FolderShare::FILE_KIND),
        ]),
        'status');
    }
  }
