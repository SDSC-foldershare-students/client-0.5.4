...
*/
  ...
  private function getAndValidateOperation(
    ...
    throw new BadRequestHttpException(t(
      Messages::HTTP_REST_INVALID_OPERATION,
      [
        '@operation' => $operation,
      ]));
  }
  ...
  private function getAndValidateReturnFormat() {
    ...
    // Fail.
    throw new BadRequestHttpException(t(
      Messages::HTTP_REST_INVALID_RETURN_FORMAT,
      [
        '@name' => $returnFormat,
      ]));
  }
  ...
  private function getSourceAndValidate(int $id = (-1), bool $required = TRUE) {
    ...
    if ($id === (-1)) {
      if ($required === TRUE) {
        throw new BadRequestHttpException(t(
          Messages::HTTP_REST_SOURCE_PATH_EMPTY));
      }
  ...
  private function getDestination(
    ...
    if ($id === (-1)) {
      if ($required === TRUE) {
        throw new BadRequestHttpException(t(
          Messages::HTTP_REST_DESTINATION_PATH_EMPTY));
      }
  ...
  private function getEntityParent(int $id) {
    ...
    if ($entity->isRootFolder() === TRUE) {
      throw new NotFoundHttpException(t(
        Messages::HTTP_REST_ROOT_HAS_NO_PARENT));
    }
  ...
  private function getEntityRoot(int $id) {
    ...
    if ($entity->isRootFolder() === TRUE) {
      throw new NotFoundHttpException(t(
        Messages::HTTP_REST_ROOT_HAS_NO_ROOT));
    }
  ...
  private function getRootList(string $scheme, int $uid = NULL) {
    switch ($scheme) {
      ...
      default:
        throw new BadRequestHttpException(t(
          Messages::HTTP_REST_INVALID_SCHEME,
          [
            '@scheme' => $scheme,
          ]));
    }
  ...
  private function download(int $id) {
    ...
    elseif ($entity->isFile() === TRUE || $entity->isImage() === TRUE) {
      ...
      throw new BadRequestHttpException(t(
        Messages::HTTP_REST_ITEM_NOT_DOWNLOADABLE,
        [
          '@name' => $entity->getName(),
        ]));
    }
  ...
  public function delete(int $id = NULL) {
    ...
    switch ($operation) {
      ...
      case 'delete-file':
        ...
        if ($entity->isFolderOrRootFolder() === TRUE) {
          throw new BadRequestHttpException(t(
            Messages::HTTP_REST_DELETE_FILE_INVALID,
            [
              '@operation' => $operation,
            ]));
        }
      ...
      case 'delete-folder':
        ...
        if ($entity->isFolderOrRootFolder() === FALSE) {
          throw new BadRequestHttpException(t(
            Messages::HTTP_REST_DELETE_FOLDER_INVALID,
            [
              '@operation' => $operation,
            ]));
        }
        ...
        if (empty($entity->getChildIds()) === FALSE) {
          throw new BadRequestHttpException(t(
            Messages::HTTP_REST_DELETE_FOLDER_NOT_EMPTY,
            [
              '@name' => $entity->getName(),
            ]));
        }
    ...
    try {
      // Delete!
      $deletedName = $entity->getName();
      $deletedKind = $entity->getKind();
      $entity->delete();

      // Log it.
      $this->logger->notice(
        Messages::DELETE_DONE_ONE_ITEM,
        [
          '@name' => $deletedName,
          '@kind' => Utilities::mapKindToTerm($deletedKind, MB_CASE_LOWER),
        ]);
  ...
  public function post(EntityInterface $dummy = NULL) {
    ...
    if ($dummy === NULL) {
      throw new BadRequestHttpException(t(
        Messages::HTTP_REST_POST_ENTITY_MISSING));
    }

    if ($dummy->getEntityTypeId() !== FolderShare::ENTITY_TYPE_ID) {
      throw new BadRequestHttpException(t(
        Messages::HTTP_REST_POST_ENTITY_WRONG_TYPE));
    }

    if (count($dummy->_restSubmittedFields) === 0) {
      throw new BadRequestHttpException(t(
        Messages::HTTP_REST_POST_ENTITY_EMPTY));
    }

    if ($dummy->isNew() === FALSE) {
      throw new BadRequestHttpException(t(
        Messages::HTTP_REST_POST_ENTITY_INVALID_ID,
        [
          '@id' => $dummy->id(),
        ]));
    }
    ...
    if (empty($dummy->getName()) === TRUE) {
      throw new BadRequestHttpException(t(
        Messages::HTTP_REST_POST_ENTITY_NAME_EMPTY));
    }
  ...
  private function postNewRootFolder(FolderShareInterface $dummy) {
    ...
    $this->logger->notice(
      ...
      [
        '@name' => $folder->getName(),
        '@kind' => Utilities::mapKindToTerm($folder->getKind(), MB_CASE_LOWER),
      ]);
  ...
  private function postNewFolder(FolderShareInterface $dummy) {
    ...
    if ($parentId === (-1)) {
      throw new BadRequestHttpException(t(
        Messages::HTTP_REST_POST_ENTITY_INVALID_PARENT_ID,
        [
          '@id' => $parentId,
        ]));
    }
...
/*
    ...
    // Note the creation in the log.
    $this->logger->notice(
      Messages::UPLOAD_DONE_ONE_ITEM,
      [
        '@name' => $file->getName(),
        '@kind' => Utilities::mapKindToTerm($file->getKind(), MB_CASE_LOWER),
      ]);
...
*/
  ...
  private function patchEntity(int $id = NULL, EntityInterface $dummy = NULL) {
    ...
    $this->logger->notice(
      Messages::UPDATE_DONE_ONE_ITEM,
      [
        '@name' => $entity->getName(),
        '@kind' => Utilities::mapKindToTerm($entity->getKind(), MB_CASE_LOWER),
      ]);
  ...
  private function patchCopy(
    ...
    if ($parts['path'] !== '/') {
      ...
      try {
        ...
        if (empty($destinationName) === TRUE) {
          throw new BadRequestHttpException(t(
            Messages::HTTP_REST_POST_DESTINATION_NAME_EMPTY));
        }
      ...
      if ($destinationId !== (-1)) {
        ...
        if ($destinationEntity === NULL) {
          throw new NotFoundHttpException(t(
            Messages::HTTP_REST_ENTITY_INVALID_DESTINATION_ID,
            [
              '@id' => $destinationId,
            ]));
        }
      ...
      switch ($parts['scheme']) {
        case FolderShare::PRIVATE_SCHEME:
          ...
          if ($uid !== (int) \Drupal::currentUser()->id()) {
            throw new AccessDeniedHttpException(t(
              Messages::HTTP_REST_COPY_TO_ANOTHER_ROOT_INVALID,
              [
        ...
        case FolderShare::PUBLIC_SCHEME:
          throw new AccessDeniedHttpException(t(
            Messages::HTTP_REST_COPY_TO_PUBLIC_ROOT_INVALID,
            [
              '@name' => $sourceEntity->getName(),
            ]));
        ...
        case FolderShare::SHARED_SCHEME:
          throw new AccessDeniedHttpException(t(
            Messages::HTTP_REST_COPY_TO_SHARED_ROOT_INVALID,
            [
              '@name' => $sourceEntity->getName(),
            ]));
      }
    ...
    if ($destinationEntity === NULL) {
      ...
      if ($sourceEntity->isFolderOrRootFolder() === FALSE) {
        throw new BadRequestHttpException(t(
          Messages::HTTP_REST_COPY_FILE_TO_ROOT_INVALID,
          [
            '@name' => $sourceEntity->getName(),
          ]));
      }
    ...
    elseif ($destinationEntity->isFolderOrRootFolder() === FALSE) {
      ...
      if ($sourceEntity->isFolderOrRootFolder() === TRUE) {
        throw new BadRequestHttpException(t(
          Messages::HTTP_REST_COPY_FOLDER_TO_FILE_INVALID,
          [
            '@name' => $sourceEntity->getName(),
          ]));
      }
      elseif ($overwrite === FALSE) {
        throw new BadRequestHttpException(t(
          Messages::HTTP_REST_COPY_FOLDER_TO_FOLDER_INVALID,
          [
            '@name' => $sourceEntity->getName(),
          ]));
      }
    ...
    if ($collisionEntity !== NULL) {
      if ($overwrite === FALSE) {
        throw new BadRequestHttpException(t(
          Messages::HTTP_REST_COPY_ITEM_TO_ITEM_INVALID,
          [
            '@name' => $checkName,
          ]));
      }
    ...
    // Note the update in the log.
    $this->logger->notice(
      Messages::COPY_DONE_ONE_ITEM,
      [
        '@name' => $sourceEntity->getName(),
        '@kind' => Utilities::mapKindToTerm($sourceEntity->getKind(), MB_CASE_LOWER),
      ]);
  ...
  private function patchMove(
    ...
    if ($destinationId === (-1)) {
      ...
      switch ($parts['scheme']) {
        case FolderShare::PRIVATE_SCHEME:
          ...
          if ($uid !== (int) \Drupal::currentUser()->id()) {
            throw new AccessDeniedHttpException(t(
              Messages::HTTP_REST_MOVE_TO_ANOTHER_ROOT_INVALID,
              [
                '@name' => $sourceEntity->getName(),
              ]));
          }
    ...
    if ($destinationEntity === NULL) {
      ...
      if ($sourceEntity->isFolderOrRootFolder() === FALSE) {
        throw new BadRequestHttpException(t(
          Messages::HTTP_REST_MOVE_FILE_TO_ROOT_INVALID,
          [
            '@name' => $sourceEntity->getName(),
          ]));
      }
    ...
    elseif ($destinationEntity->isFolderOrRootFolder() === FALSE) {
      ...
      if ($sourceEntity->isFolderOrRootFolder() === TRUE) {
        throw new BadRequestHttpException(t(
          Messages::HTTP_REST_MOVE_FOLDER_TO_FILE_INVALID,
          [
            '@name' => $sourceEntity->getName(),
          ]));
      }
      elseif ($overwrite === FALSE) {
        throw new BadRequestHttpException(t(
          Messages::HTTP_REST_MOVE_FOLDER_TO_FOLDER_INVALID,
          [
            '@name' => $sourceEntity->getName(),
          ]));
      }
    ...
    if ($collisionEntity !== NULL) {
      if ($overwrite === FALSE) {
        throw new BadRequestHttpException(t(
          Messages::HTTP_REST_MOVE_ITEM_TO_ITEM_INVALID,
          [
            '@name' => $checkName,
          ]));
      }
